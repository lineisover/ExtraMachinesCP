...
* Изменена структура мода, для лучшей совместимости с функционалом мердж модов.
* Файлы переименованы в нижний регистр для минимизации возможных проблем с linux системами.
* Адаптация под nekto MOD 5.2 ComRem Edition

# 2.0.1

* Исправлена логика при переустановке мода на ISL
* Исправлен скин 3 кузова ChevC10

# 2.0.0

* Мод перенесен на систему merge модов
* Исправлено множество мелких ошибок
* Чит коды для машин из мода перенесены в отдельный файл
